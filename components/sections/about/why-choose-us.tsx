...
export function WhyChooseUs() {
  ...
  return (
    <section className="py-32 bg-blue-50 border-y border-primary/10 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-start">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl lg:text-7xl font-heading font-black mb-8 text-foreground leading-[1] tracking-tighter">
              More than <br/>
              <span className="text-transparent text-outline" style={{ WebkitTextStroke: '1px rgba(15,23,42,0.3)' }}>code and</span> <br/>
              design.
            </h3>
            <p className="text-lg text-muted-foreground leading-relaxed max-w-md font-light mb-12">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start gap-8">
                  <div className="w-12 h-12 rounded-none border border-primary/10 flex items-center justify-center bg-white group-hover:bg-primary group-hover:border-primary transition-colors duration-500 shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground font-light leading-relaxed group-hover:text-slate-600 transition-colors duration-300">
                      {feature.desc}
                    </p>
                  </div>
                </div>
